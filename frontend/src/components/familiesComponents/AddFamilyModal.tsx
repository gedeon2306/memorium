...
import { createFamily } from "@/app/actions/actions";
...
export interface AddFamilyModalHandle {
  open: () => void;
}

const AddFamilyModal = forwardRef<AddFamilyModalHandle, AddFamilyModalProps>(
  ({ onSuccess }, ref) => {
    ...
    const validate = (data: FormData): Record<string, string> => {
      ...
      if (profession && profession.length > 50)
        errs.profession = "Maximum 50 caractères.";
            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-white/35 mt-0.5">
                  Enregistrer une nouvelle famille dans Memorium
                </p>
              </div>
            </div>
            <button
...
AddFamilyModal.displayName = "AddFamilyModal";

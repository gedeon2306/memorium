              ...
              <div className="space-y-4">
                ...
                <div className="alert alert-warning">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      Vous êtes sur le point de supprimer la famille suivante :
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/2 border border-white/10 rounded-lg p-4">
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-white/60">Nom de famille :</span>
                      <span className="text-white font-medium">{selected.nom_famille}</span>
                    </div>
                    <div className="flex justify-between">

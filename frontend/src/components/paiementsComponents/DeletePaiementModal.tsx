...
import { deletePaiement } from "@/app/actions/actions";
...
export interface DeletePaiementModalHandle {
  open: (paiement: any) => void;
}

const DeletePaiementModal = forwardRef<DeletePaiementModalHandle, DeletePaiementModalProps>(
  ({ onSuccess }, ref) => {
    ...
    const handleDelete = async () => {
      ...
      try {
        const result = await deletePaiement({ id: currentPaiement.id });
              ...
              <div className="space-y-4">
                ...
                <div className="alert alert-warning">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      Vous êtes sur le point de supprimer le paiement suivant :
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/2 border border-white/10 rounded-lg p-4">
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-medium">{currentPaiement.num_facture}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-white/60">Famille :</span>
                      <span className="text-white font-medium">{currentPaiement.famille_nom}</span>
                    </div>
                    <div className="flex justify-between">
...
DeletePaiementModal.displayName = "DeletePaiementModal";
export default DeletePaiementModal;
